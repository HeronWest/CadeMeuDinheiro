...
class AdmConsultPage extends StatefulWidget {
  ...
  @override
  State<AdmConsultPage> createState() => _consultPageState();
}
                            ...
                            rows: List<DataRow>.generate(
                                _movimentStore.moviments.length,
                                  ...
                                  DataCell(SizedBox(
                                    ...
                                    onTap: () async {
                                    await _movimentStore.setLocalController(_movimentStore.moviments[index].local!);
                                    await _movimentStore.setDateController(_movimentStore.moviments[index].date!);
                                    await _movimentStore.setValueController(_movimentStore.moviments[index].value!.toStringAsFixed(2));
                                    await _movimentStore.setDescriController(_movimentStore.moviments[index].descri!);
                                    await _movimentStore.setIdController(_movimentStore.moviments[index].id);
                                    Navigator.pushNamed(context,'/edit_mov_page');
                                    }
                                  ),
                                  DataCell(SizedBox(
                                    width: screenSize.width * 0.2,
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  if (dropdownValue != 'Ambos') {
                                    _movimentStore
                                        .setMovimentsByType(_admStore.userFilterId!,dropdownID);
                                  } else {
                                    _movimentStore.setMoviments(_admStore.userFilterId!);
                                  }
                                },
                                child: const Text(
                                  'CONSULTAR',
